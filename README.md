...
docker-teamspeak and TeamSpeak itself.
    ...
    git clone https://github.com/marcosArruda/docker-teamspeak
    cd docker-teamspeak
    docker build -t marruda/teamspeak .
...
`mkdir -p /mnt/teamspeak`.
    ...
    sudo docker run -d=true -p=9987:9987/udp -p=10011:10011 -p=30033:30033 -v=/mnt/teamspeak:/data marruda/teamspeak /start
